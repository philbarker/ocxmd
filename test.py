...
METADATAEXPECTED_1 = {1: {"@context": "http://schema.org/", "@id": "#lesson1", "@type": "CreativeWork"}}
...
METADATAEXPECTED_2 = {1: {'@context': 'http://schema.org', '@id': '#lesson1', 'name': 'Test Lesson 1', '@type': ['oer:Lesson', 'CreativeWork'], 'learningResourceType': 'LessonPlan', 'hasPart': {'@id': '#activity1'}, 'author': {'@type': 'Person', 'name': 'Fred Blogs'}}, 2: {'@context': 'http://schema.org', '@id': '#activity1', '@type': ['oer:Activity', 'CreativeWork'], 'name': 'Test Activity 1.1', 'learningResourceType': 'Activity'}}

METADATAEXPECTED_3 = {1: {'@context': ['http://schema.org', {'oer': 'http://oerschema.org/'}, {'ocx': 'https://github.com/K12OCX/k12ocx-specs/'}], '@id': '#lesson1', 'name': 'Test Lesson 1', '@type': ['oer:Lesson', 'CreativeWork'], 'learningResourceType': 'LessonPlan', 'hasPart': {'@id': '#activity1'}, 'author': {'@type': 'Person', 'name': 'Fred Blogs'}}, 2: {'@context': ['http://schema.org', {'oer': 'http://oerschema.org/'}, {'ocx': 'https://github.com/K12OCX/k12ocx-specs/'}], '@id': '#activity1', '@type': ['oer:Activity', 'CreativeWork'], 'name': 'Test Activity 1.1', 'learningResourceType': 'Activity'}}
...
def test1_2():
        md = markdown.Markdown(extensions = ['ocxmd'], extension_configs = {'ocxmd': {'context' : '\'@context\' : \'http://schema.org\''}})
        html = md.convert(TESTINPUT_1_1)
        assert md.meta == METADATAEXPECTED_1
        assert html == HTMLEXPECTED_1
...
def test3():
    md = markdown.Markdown(extensions = ['ocxmd'], extension_configs = {'ocxmd': {'context' : YAML_CONTEXT}} )
    html = md.convert(TESTINPUT)
